    ...
    if (!post) {
      root.innerHTML = `
        <div class="text-center container" style="padding:80px">
          ...
          <p style="margin-top:16px"><a href="/products/a2-gir-milk/">Shop A2 Gir Cow Milk</a></p>
        </div>`;
      return;
    }

    document.title = `${post.seoTitle || post.title} — Gir Govalan Blog`;
