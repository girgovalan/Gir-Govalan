...
const HOME_IMAGES = {
  gheeProcessJourney: homeImg('gir-govalan-bilona-ghee-process.png')
};
...
const PRODUCTS = [
  {
    ...
    metaDescription: "Buy pure A2 Gir cow bilona ghee online from Gir Govalan, Gujarat. Curd-churned, single-ingredient desi ghee for daily cooking, tadka, and festival sweets. Free delivery above ₹999.",
    keywords: "buy A2 Gir cow ghee online, bilona ghee Gujarat, pure desi ghee, A2 bilona ghee, Gir cow ghee online India, authentic Gir ghee, hand churned ghee",
    price: 1300,
    compareAt: 1399,
    category: 'ghee',
    imageStyle: 'fill',
...
<li><a href="/blogs/news/fresh-milk-delivery-vs-packaged/">Fresh Farm Milk vs Packaged Milk</a></li>
  ...
  },
  {
    ...
    metaDescription: "Buy fresh thick curd (dahi) made from Gir cow milk at Gir Govalan. Creamy homemade-style dahi for thali, raita, and daily meals. Farm-fresh dairy from Gujarat.",
    keywords: "fresh curd online, Gir cow dahi, buy fresh dahi Gujarat, thick homemade curd, A2 milk curd, farm fresh dahi",
    price: 150,
    compareAt: 165,
    category: 'dairy',
    imageStyle: 'fill',
  ...
  },
  {
    ...
    metaDescription: "Buy traditional ladoo made with Gir Govalan bilona ghee. Homestyle festival mithai for Diwali, Raksha Bandhan, and gifting — authentic taste, not oily or overly sweet.",
    keywords: "traditional ladoo online, bilona ghee ladoo, festival sweets Gujarat, buy ladoo Diwali, desi ghee ladoo, Gir Govalan mithai",
    price: 349,
    compareAt: 379,
    category: 'sweets',
  ...
  },
  {
    ...
    metaDescription: "Buy soft milk peda handcrafted from A2 Gir cow milk and bilona ghee. Authentic Gujarati mithai for Diwali gifting and family sweets — small batches, pure taste.",
    keywords: "milk peda online, A2 milk peda, Gujarati peda, buy doodh peda, bilona ghee peda, Diwali mithai Gujarat",
    price: 650,
    compareAt: 699,
    category: 'sweets',
    imageStyle: 'fill',
...
<p class="product-tagline"><strong>Gir Govalan – Pure Tradition. Pure Sweetness. Pure Peda.</strong></p>`,
  ...
  },
  {
    ...
    metaDescription: "Buy creamy Gujarati shrikhand made from hung curd at Gir Govalan. Natural sweetness for puri, festivals, and weekend thali — farm dairy tradition from Gujarat.",
    keywords: "buy shrikhand online, Gujarati shrikhand, hung curd sweet, fresh shrikhand Gujarat, homemade style shrikhand",
    price: 299,
    compareAt: 329,
    category: 'sweets',
